...
data = pd.read_excel('https://github.com/sc-katu/cropprotection/raw/main/path/to/your/ZIKR_vrediteli.xlsx')
data_gorhcak = pd.read_excel('https://github.com/sc-katu/cropprotection/raw/main/path/to/your/ZIKR_vrediteli.xlsx',sheet_name='Горчак')
data_mol = pd.read_excel('https://github.com/sc-katu/cropprotection/raw/main/path/to/your/ZIKR_vrediteli.xlsx',sheet_name='Капустная_моль')
data_pochvoobit = pd.read_excel('https://github.com/sc-katu/cropprotection/raw/main/path/to/your/ZIKR_vrediteli.xlsx',sheet_name='Почвообитающие')
...
def second_page():
    st.title("Прогнозирование. Горчак")
    # Create a Markdown table
    markdown_table = """
    | Наименование предиктора               | Описание                                        |
    |-----------------------|----------------------------------------------------|
...
def fourth_page():
    st.title("Прогнозирование. Почвообитающие")
    # Create a Markdown table
    markdown_table = """
    | Наименование предиктора               | Описание                                    |
    |-----------------------|----------------------------------------------------|
...
page = st.sidebar.selectbox("Вредители", ("Септориоз", "Горчак","Капустная моль", "Почвообитающие"))
